...
const {
    findAllDraftsForShop, publishProductByShop, findAllPublishForShop, unPublishProductByShop, searchProductByUser,
...
class Clothing extends Product {
    ...
    async updateProduct(productId) {
        ...
        console.log(`[3]:: `, updateNestedObjectParser(objectParams));
...
class Electronics extends Product {
    ...
    async createProduct() {
        console.log('day la electronics: ', this);
        ...
        console.log('Electronics is ', newProduct);
        if (!newProduct) throw new BadRequestError('create new Product error');
        return newProduct
    }
